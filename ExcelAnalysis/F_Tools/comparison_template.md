# CBAM Sheet Comparison: F_Tools

## Overview
This document compares the F_Tools Excel sheet with its corresponding implementation in the web application.

## Sheet Information

### Sheet Name
- **Excel Sheet Name**: F_Tools
