# CBAM Sheet Comparison: Summary_Products

## Overview
This document compares the Summary_Products Excel sheet with its corresponding implementation in the web application.

## Sheet Information

### Sheet Name
- **Excel Sheet Name**: Summary_Products
